/*
 * Program which computes the time taken by the bubble sort in different types of inputs
 *
 * Compilation: gcc -o bubble_sort bubble_sort.c
 * Execution: ./bubble_sort 
 * @Harsh_Garg,1910990582,00/00/0000
 * Assignement 2
 */
...
/*
 *Function that will sort the array using bubble sort algorithm
 *
 * Parameter:
...
/*
 * Function that will print the time taken by the bubble sort for:
