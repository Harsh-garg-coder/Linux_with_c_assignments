/*
 * Program which computes the time taken by the Insertion sort in different types of inputs
 *
...
/*
 *Function that will sort the array using insertion sort algorithm
 *
 * Parameter:
...
/*
 * Function that will print the time taken by the insertion sort for:
